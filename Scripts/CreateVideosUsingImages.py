...
filein = r'C:\Users\ldfierro\OneDrive - University of Tasmania\ACCESS_Outputs\Figures\Maps\SeaIceSeasonality\Anomalies\Yearly'
#Set the file path for the video to be save, include the name of the video and its extension
fileout = os.path.join(filein, 'VideoSeaIceSeasonalityYrAnom_1965-2018.gif')
